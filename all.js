...
//Create Task and List
            ...
            function createToDo (toDo) {
                 ...
                 $scope.toDos.push(toDo);
                    //   {'action': toDo,'list':toDo.list, 'id':toDo.id}
                  resetCreateTask();
            }
...
// Stars
            ...
            $http.get ('tasks.json').then(function (response) {$scope.lists = response.data.lists;});
                                         
            $http.get ('tasks.json').then(function (response) {$scope.toDos = response.data.tasks;});


         //  $http.get ('tasks/actions.json').then(function(response) {$scope.toDos = response.data;});
